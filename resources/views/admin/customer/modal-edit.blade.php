                ...
                <div class="mt-0 row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="instagram" name="instagram" class="form-control form-control-sm" placeholder="Ex:" aria-label="instagram" id="instagram" value="{{ $customer->instagram ?? old('instagram') }}">
